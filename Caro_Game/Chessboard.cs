...
namespace Caro_Game
{
    public class Chessboard
    {
        ...
        public void drawChess_Board(Point p,Bitmap bm)
        {
            ...
            //_grsChessBoard.DrawRectangle(new Pen(cl,ConstProject._SizeBoderChessBoard+0.2f),
            //    p.X+2,p.Y+2, ConstProject._ChessBoard_SizeWitdth-3, ConstProject._ChessBoard_SizeHeight-3);
        }
    }
}
